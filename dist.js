...
window.onload = function (event) {
  ...
  img.onload = function () {
    ...
    function getColorAtPoint(context, _ref2) {
      var x = _ref2.x,
          y = _ref2.y;
    ...
    function step() {
      ...
      var triangles = triangulate(pntsArr);

      triangles.forEach(function (tri, index) {
        var pntsNow = tri.map(function (pntNum) {
          return points[pntNum];
        });

        var color = get3ColorAvg(bctx, pntsNow);
...
var ch = __webpack_require__(6)
var uniq = __webpack_require__(14)
...
var orient = __webpack_require__(7)
var compareCell = __webpack_require__(11).compareCells
...
var robustSum = __webpack_require__(10)
var robustScale = __webpack_require__(8)
var robustSubtract = __webpack_require__(9)
...
var bits      = __webpack_require__(2)
  , UnionFind = __webpack_require__(13)
